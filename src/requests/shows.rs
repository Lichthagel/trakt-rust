...
impl TraktApi {
    pub fn shows_trending(
        &self,
    ) -> PaginationRequest<ShowInfo> {
        PaginationRequest::new(self, self.builder(Method::GET, api_url!(("shows", "trending"))))
    }

    pub fn shows_popular(
        &self,
    ) -> PaginationRequest<Show> {
        PaginationRequest::new(self, self.builder(Method::GET, api_url!(("shows", "popular"))))
    }
    ...
    pub fn shows_played(
        ...
        PaginationRequest::new(self, self.builder(Method::GET, api_url!(("shows", "played", period))))
    }
    ...
    pub fn shows_watched(
        ...
        PaginationRequest::new(self, self.builder(Method::GET, api_url!(("shows", "watched", period))))
    }
    ...
    pub fn shows_collected(
        ...
        PaginationRequest::new(self, self.builder(Method::GET, api_url!(("shows", "collected", period))))
    }

    pub fn shows_anticipated(
        &self,
    ) -> PaginationRequest<AnticipatedShow> {
        PaginationRequest::new(self, self.builder(Method::GET, api_url!(("shows", "anticipated"))))
    }

    pub fn shows_updates(
        &self
    ) -> PaginationRequest<UpdatedShow> {
        PaginationRequest::new(self, self.builder(Method::GET, api_url!(("shows", "updates"))))
    }
    ...
    pub fn show_comments(&self, id: impl Display) -> PaginationRequest<Comment> {
        PaginationRequest::new(self, self.builder(Method::GET, api_url!(("shows", id, "comments"))))
    }
